...
function check1() {
  ...
  // 배열 선언 방법 확인
  const arr1 = new Array();  // 비어있는 0칸짜리 배열
  ...
  console.log('arr[4] :', arr4[0]);
  console.log('arr[4] :', arr4[1]);
  console.log('arr[4] :', arr4[2]);
  ...
  // JS 배열의 특징 : 인덱스별로 자료형을 다르게 저장할 수 있다.
