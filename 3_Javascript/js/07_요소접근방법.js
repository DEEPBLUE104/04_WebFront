...
function nameTest(){
  ...
  for(let i = 0; i <hobbyList.length; i++){
    ...
    // input요소.checked = false; -> 해당 요소를 언체크하겠다.
  ...
  // 요소.innerHTML
  // HTML 태그를 포함하여 문자열 등을 실제
  // HTML 요소로 해석함
  
  // 요소.innerText
  // 텍스트 내용만 요소 콘텐트 내부에 출력함.
...
function readValue(){
  ...
  bg.scrollTop = bg.scrollHeight;  // 스크롤 아래쪽 고정
