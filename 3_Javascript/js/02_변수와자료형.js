...
const gender = 'M'; // 한 글자만 작성해도 문자열 (String) //char 아님
...
typeof numbers[3]); //undefined undefined

// javascript에서 배열은 값 추가 및 삭제 가능
...
console.log(typeof sumFn); //function 타입
